...
class Dziennik(object):
    ...
    @classmethod
    def DziennikAla(cls):
        return cls("dziennik.ala.dz")

    @classmethod
    def DziennikJan(cls):
        return cls("dziennik.jan.dz")
...
def zapytaj_o_dziennik():
    dziennik_pick = input("Który dziennik?\n"
          "1. Oryginał\n"
          "2. Ala\n"
          "3. Jan")
    if dziennik_pick == "1":
        dziennik = Dziennik()
    if dziennik_pick == "2":
        dziennik = Dziennik.DziennikAla()
    if dziennik_pick == "3":
        dziennik = Dziennik.DziennikJan()
    return dziennik
...
while True:
    ...
    # dziennik_= Dziennik.DziennikAla()
    # dziennik = Dziennik.DziennikJan()
    dziennik = zapytaj_o_dziennik()
    wyswietl_menu()
    zapytaj()
